...
var gio = moment.tz('Asia/Ho_Chi_Minh').format('HH:mm:ss || D/MM/YYYY');
      ...
      if (event.body && event.body.startsWith(prefix)) return api.sendMessage(`💓 ━━━━[ Thuê Bot ]━━━━ 💓\n━━━━━━━━━\n👑』» Admin : Khanh Shado\n🌐』» Link Profile : https://wwww.facebook.com/100090458979503\n♚────────♔────────♚\n[⏰] → Bây giờ là: ${gio}\n[🆔] → BoxID: ${event.threadID}\n『🌪️』»  Nhóm của bạn chưa thuê bot. Vui lòng thuê bot để tiếp tục sử dụng\n『❤️』» Hoặc có thể ghi KhanhDzz để được admin cho free 1 tháng nhé, còn tùy admin muốn cho bao nhiêu lâu nữa ạ\n━━━━━━━━━\n『⏳』»  Bot Online Được : Giờ Phút Giây\n『⚙️』»  Tốc độ sử lý lệnh : ms\n[📩] → Để gửi yêu cầu duyệt dùng: ${prefix}request`, event.threadID);
    };
    switch (event.type) {
