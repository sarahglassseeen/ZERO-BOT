...
module.exports.config = {
	name: "zero", // Tên lệnh, được sử dụng trong việc gọi lệnh
	version: "1.2.2-superfix", // phiên bản của module này
	hasPermssion: 0, // Quyền hạn sử dụng, với 0 là toàn bộ thành viên, 1 là quản trị viên trở lên, 2 là admin/owner
	credits: "ZERO", // Công nhận module sở hữu là ai
...
module.exports.languages = {
	"vi": {
        "missingInput": "[ ZERO ] Số tiền đặt cược không được để trống hoặc là số âm",
        "moneyBetNotEnough": "[ ZERO ] Số tiền bạn đặt lớn hơn hoặc bằng số dư của bạn!",
        "limitBet": "[ ZERO ] Số coin đặt không được dưới 50$!",
        "noGame": "[ ZERO ] Nhóm của bạn không có ván xì dách nào đang diễn ra cả!",
        "xidachRules": "≪≪≪≪[ ZERO ]≫≫≫≫\n            <NOTE> \n => xì dách là: 1 A + 1 trong J Q K => xì bàng: 2A\n\n [=🐣=]->Luật:điểm từ 16 đến 21:\n [⚜️] người chơi > nhà cái người chơi có xì bàng hoặc xì dách nhà cái ko có => x4 thưởng và ngược lại\n\n [⚜️] xì bàng > xì dách:người chơi có xì bàng hoặc xì dách, nhà cái k có -> x4 thưởng => người chơi có xì bàng, nhà cái có xì dách -> x2 thưởng => người chơi có xì dách, nhà cái xì bàng -> Lose\n\n [⚜️] Ngũ linh: 5 lá bài mà tổng điểm nhỏ hơn 21. Người chơi Win tuyệt đối. Trường hợp cả 2 bên đều ngũ linh, ai ít điểm hơn sẽ Win.\n\n [⚜️] Quá 21 điểm: 2 bên cùng quá thì ai ít điểm hơn sẽ Win. Quá 21 điểm thì Win bài thấp hơn 16 điểm (non).\n\n        [===HDSD===]\n[💓] xidach create (tiền_cược)=>(tối thiểu 50$)\n[💓] xidach join (tiền_cược)=>(tối thiểu 50$)\n[💓] xidach leave (rời ván xì dách đang tham gia ở nhóm)\n[💓] xidach start (bắt đầu ván xì dách mà bạn tạo ở nhóm)",
        "magic_five": "Ngũ Linh",
        "blackJack": "Xì Dách",
...
module.exports.onLoad = async () => {
	...
	console.log("-----ZERO LOADED SUCCESSFULLY------");
};
